  ...
  sections: [
    {
      ...
      paragraphs: [
        "XR Technology, basée à Antananarivo (Madagascar), est responsable des données personnelles collectées via ce site.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "Vos données sont accessibles à l'équipe de XR Technology chargée du suivi commercial. Elles sont hébergées chez notre prestataire technique (Supabase). Les données de mesure et de publicité sont traitées, selon votre consentement, par Google et Meta.",
      ],
    },
    {
